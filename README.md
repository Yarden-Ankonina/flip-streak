...
FlipStreak is configured as a Progressive Web App (PWA) and can be installed on Android and iOS devices.
...
Icons need to be generated and placed in `web/public/`:

- `pwa-192x192.png` (Android)
- `pwa-512x512.png` (Android)
- `apple-touch-icon.png` (iOS - 180x180px)

See `web/public/PWA_ICONS_README.md` for instructions on generating icons.
...
- PWA service worker is automatically generated by vite-plugin-pwa
- PWA works in development mode (devOptions enabled)
